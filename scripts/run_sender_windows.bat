...
python sender\sender.py --model models\best.pt --server-url "%RECEIVER_URL%" --device-id "%DEVICE_ID%" --camera %CAMERA_INDEX% --camera-api dshow --device "%YOLO_DEVICE%" --preview
